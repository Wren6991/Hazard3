...
int main() {
    ...
    check_equal(__extendhfsf2(0x8000), 0x80000000);
    check_equal(__extendhfsf2(0x0001), 0x00000000);
    check_equal(__extendhfsf2(0x8001), 0x80000000);
    check_equal(__extendhfsf2(0x03ff), 0x00000000);
    ...
    check_equal(__fixsfsi(0x00000000),  0                       ); // +- 0
    check_equal(__fixsfsi(0x80000000),  0                       );
    check_equal(__fixsfsi(0x007fffff),  0                       ); // +- subnormal
    check_equal(__fixsfsi(0x807fffff),  0                       );
    check_equal(__fixsfsi(0x3f000000),  0                       ); // +- 1/2 (note GCC requires truncate-to-zero)
    check_equal(__fixsfsi(0xbf000000),  0                       );
    check_equal(__fixsfsi(0x3f800000),  1                       ); // +- 1
    check_equal(__fixsfsi(0xbf800000), -1                       );
    check_equal(__fixsfsi(0x3f7fffff),  0                       ); //  1 - 1ulp
    check_equal(__fixsfsi(0xbf7fffff),  0                       ); // -1 + 1ulp
    check_equal(__fixsfsi(0x4f000000), INT_MAX                  ); // max exponent
    check_equal(__fixsfsi(0xcf000000), INT_MIN                  );
    check_equal(__fixsfsi(0x4e800000), -(INT_MIN >> 1)          );
    check_equal(__fixsfsi(0xce800000), INT_MIN >> 1             );
    check_equal(__fixsfsi(0x4f7fffff), INT_MAX                  );
    check_equal(__fixsfsi(0xcf7fffff), INT_MIN                  );
    check_equal(__fixsfsi(0x4f800000), INT_MAX                  );
    check_equal(__fixsfsi(0xcf800000), INT_MIN                  );
    check_equal(__fixsfsi(0x7f800000), INT_MAX                  ); // +-inf
    check_equal(__fixsfsi(0xff800000), INT_MIN                  );
    check_equal(__fixsfsi(0x7fffffff), INT_MAX                  ); // "+-nan"
    check_equal(__fixsfsi(0xffffffff), INT_MIN                  );
    check_equal(__fixsfsi(0x4b7fffff), (1 << 24) - 1            ); // largest odd number
    check_equal(__fixsfsi(0xcb7fffff), -(1 << 24) + 1           ); // smallest odd number
    check_equal(__fixsfsi(0x4effffff), INT_MAX - (1 << 7) + 1   ); // largest non-saturated
    check_equal(__fixsfsi(0xceffffff), -(INT_MAX - (1 << 7) + 1)); // smallest non-saturated

    // Reverse of above, with rhs canonicalised and NaNs and infinities removed
    check_equal(__floatsisf( 0                       ), 0x00000000);
    check_equal(__floatsisf( 1                       ), 0x3f800000); // +- 1
    check_equal(__floatsisf(-1                       ), 0xbf800000);
    check_equal(__floatsisf(INT_MAX                  ), 0x4f000000); // max exponent
    check_equal(__floatsisf(INT_MIN                  ), 0xcf000000);
    check_equal(__floatsisf(-(INT_MIN >> 1)          ), 0x4e800000);
    check_equal(__floatsisf(INT_MIN >> 1             ), 0xce800000);
    check_equal(__floatsisf((1 << 24) - 1            ), 0x4b7fffff); // largest odd number
    check_equal(__floatsisf(-(1 << 24) + 1           ), 0xcb7fffff); // smallest odd number
    check_equal(__floatsisf(INT_MAX - (1 << 7) + 1   ), 0x4effffff); // largest non-saturated
    check_equal(__floatsisf(-(INT_MAX - (1 << 7) + 1)), 0xceffffff); // smallest non-saturated
    ...
    check_equal(__floatunsisf( 2                     ), 0x40000000); // 2
    check_equal(__floatunsisf((1 << 24) - 1          ), 0x4b7fffff); // largest odd number
    check_equal(__floatunsisf(UINT_MAX - (1 << 8) + 1), 0x4f7fffff); // largest non-saturated
    check_equal(__floatunsisf((UINT_MAX >> 1) + 1    ), 0x4f000000); // one less than max exponent
    check_equal(__floatunsisf(UINT_MAX               ), 0x4f800000); // max exponent
