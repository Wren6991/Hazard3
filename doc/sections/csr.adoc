...
| 3 | Breakpoint: fires when executing an `ebreak` instruction, or as a result of a trigger (see <<section-trigger-module>>) that target M-mode (i.e. <<reg-tdata1>>.`action` = `0`).
