...
always @ (*) begin
	...
	`RVOPC_FENCE:     begin raw_rd = X0; raw_rs1 = X0; raw_rs2 = X0; raw_fence_d = 1'b1; end
	`RVOPC_FENCE_I:   if (EXTENSION_ZIFENCEI)    begin raw_rd = X0; raw_rs1 = X0; raw_rs2 = X0; raw_except = debug_mode ? EXCEPT_NONE : EXCEPT_REFETCH; raw_fence_i = 1'b1; end else begin d_invalid_32bit = 1'b1; end
