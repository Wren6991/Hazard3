...
`define RVOPC_FENCE       32'b?????????????????000?????0001111
`define RVOPC_FENCE_I     32'b?????????????????001?????0001111
...
`define RVOPC_BEQI        32'b?????????????????010?????1100011
`define RVOPC_BNEI        32'b?????????????????011?????1100011
...
`define RVOPC_H3_FUNPACKQ3_H 32'b000000000000?????001?????0001011 // custom-0 funct3=1 funct7=0x00
`define RVOPC_H3_FUNPACKQ3_S 32'b100000000000?????001?????0001011 // custom-0 funct3=1 funct7=0x40
`define RVOPC_H3_FUNPACKU3_H 32'b000000100000?????001?????0001011 // custom-0 funct3=1 funct7=0x00
`define RVOPC_H3_FUNPACKU3_S 32'b100000100000?????001?????0001011 // custom-0 funct3=1 funct7=0x40
`define RVOPC_H3_FCHECK2E_H  32'b0000010??????????001?????0001011 // custom-0 funct3=1 funct7=0x01
`define RVOPC_H3_FCHECK2E_S  32'b1000010??????????001?????0001011 // custom-0 funct3=1 funct7=0x41
`define RVOPC_H3_FPACKRQ3_H  32'b0000011??????????001?????0001011 // custom-0 funct3=1 funct7=0x02
`define RVOPC_H3_FPACKRQ3_S  32'b1000011??????????001?????0001011 // custom-0 funct3=1 funct7=0x42
`define RVOPC_H3_FEADJQ3     32'b000010000000?????001?????0001011 // custom-0 funct3=1 funct7=0x04
`define RVOPC_H3_FEADJU3     32'b000010100000?????001?????0001011 // custom-0 funct3=1 funct7=0x05
`define RVOPC_H3_XORSIGN     32'b0000110??????????001?????0001011 // custom-0 funct3=1 funct7=0x06
`define RVOPC_H3_SSRLSTICKY  32'b0001010??????????001?????0001011 // custom-0 funct3=1 funct7=0x0a
`define RVOPC_H3_SSRASTICKY  32'b0101010??????????001?????0001011 // custom-0 funct3=1 funct7=0x0b
`define RVOPC_H3_SSRL        32'b0001000??????????001?????0001011 // custom-0 funct3=1 funct7=0x0c
`define RVOPC_H3_SSRA        32'b0101000??????????001?????0001011 // custom-0 funct3=1 funct7=0x0d
`define RVOPC_H3_SSLL        32'b0001100??????????001?????0001011 // custom-0 funct3=1 funct7=0x0c
`define RVOPC_H3_SSLA        32'b0101100??????????001?????0001011 // custom-0 funct3=1 funct7=0x0d
// (catch-all)
`define RVOPC_H3_SFX         32'b?????????????????001?????0001011
