...
`define RVOPC_H3_XNORSIGN    32'b0000111??????????001?????0001011 // custom-0 funct3=1 funct7=0x07
`define RVOPC_H3_SSRLSTICKY  32'b0001010??????????001?????0001011 // custom-0 funct3=1 funct7=0x0a
`define RVOPC_H3_SSRASTICKY  32'b0001011??????????001?????0001011 // custom-0 funct3=1 funct7=0x0b
`define RVOPC_H3_SSLL        32'b0001100??????????001?????0001011 // custom-0 funct3=1 funct7=0x0c
`define RVOPC_H3_SSLA        32'b0001101??????????001?????0001011 // custom-0 funct3=1 funct7=0x0d
// (catch-all)
